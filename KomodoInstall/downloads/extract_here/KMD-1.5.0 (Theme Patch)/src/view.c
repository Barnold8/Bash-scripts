...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  // DARK_THEME_PATCH: gtk_widget_set_style(clist, fixed_style);
...
// DARK_THEME_PATCH: gtk_box_pack_end(GTK_BOX(hbox), logoitem, FALSE, FALSE, 0);
...
// DARK_THEME_PATCH: gtk_widget_set_style(text, fixed_style);
...
// DARK_THEME_PATCH: gtk_widget_set_style(regwindow->clist_ptr, fixed_style);
...
// DARK_THEME_PATCH: gtk_widget_set_style(handle, fixed_style);
if (function != NULL)
